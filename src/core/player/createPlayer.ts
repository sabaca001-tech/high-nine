...
const SURNAMES = [
  ...
  '小川', '中島', '平田', '大森', '新井', '吉川', '望月', '水野', '浅野', '黒田',
  '堀', '児玉', '小松', '田口', '神田', '森本', '熊谷', '佐野', '荒木', '山中',
  '大島', '川上', '松村', '鎌田', '米田', '相馬', '若林', '天野', '岸本', '柏木',
  '北村', '西田', '沢田', '平井', '堀内', '藤川', '宇野', '篠原', '榎本', '竹田',
  '香川', '早川', '深沢', '三宅', '谷川', '河合', '岡部', '塚本', '岩本', '小山',
  '中田', '浜田', '須藤', '葛西', '角田', '土屋', '矢野', '奥村', '片山', '関口',
]
...
const GIVEN_NAMES = [
  ...
  '直哉', '和樹', '雄太', '駿介', '拓真', '琉', '奏', '壮太', '智樹', '啓介',
  '将吾', '悠希', '翔大', '昊', '伊織', '千尋', '悠斗郎', '要', '旭', '大空',
  '柊', '楽', '翔琉', '陸斗', '琉聖', '聖也', '怜', '煌', '幹太', '宗一郎',
  '虎太郎', '日向', '悠仁', '蒼真', '和真', '敦也', '光太郎', '駿平', '拓斗', '裕翔',
  '航大', '惺', '蓮斗', '裕貴', '正輝', '貫太', '歩夢', '望', '珠緒斗', '奏汰',
]
...
const FEMALE_GIVEN_NAMES = [
  ...
  '真凛', '詩織', '小春', '日菜', '美月', '麻衣', '和香', '紗希', '優月', '玲奈',
  '南', '里穂', '舞', '千尋', '綾乃', '杏', 'ひかり', '桜', '美緒',
]
 ...
 * 素質0のときの球速。
 *
 * **111から下げてある。** 評価点で球速を掛け算にしたので、
 * 生成される投手の球速がそのまま投手の値打ちを決めるようになった。
